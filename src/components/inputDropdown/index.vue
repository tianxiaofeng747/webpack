<template>
  <section class="my-drop-down">
    <el-input v-model.trim="value" :disabled="disabled" v-bind="formatAttr(config.attr)" clearable @click.native.stop="handleDropdown" @blur="changeValue(value)"></el-input>
    <div class="drop-down-box" v-if="dropShow && !disabled" @click.stop v-loading="isLoading">
      <ul>
        <slot name="content">
...
export default {
    ...
    methods: {
        getList (pageIndex = this.page.pageIndex, pageSize = this.page.pageSize) {
            ...
            this.Http(this.config.get.url, options).then(res => {
    ...
    .drop-down-box{
        ...
        .footer{
           ...
           ::v-deep .el-pagination__total{
             ...
             ::v-deep .input-er .el-input__inner{
